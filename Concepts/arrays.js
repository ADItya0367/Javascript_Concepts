...
// arrays are defined as a collection of elements of the same datatype.
// means if i want to store multiple values in a single variable then i will use arrays.
// //example
let arr=[1,2,3,4,5];
